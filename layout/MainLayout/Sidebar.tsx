      ...
      {accessToken && (
        ...
        >
          <div className="flex h-full flex-col">
            ...
            >
              ...
              {isHovered || isOpen ? (
                <div className="relative z-10 flex w-full items-center justify-center text-white">
                  ...
                  <button
                    onClick={closeSidebar}
                    className="absolute right-4 flex h-8 w-8 items-center justify-center rounded-lg transition-colors hover:bg-white/20 md:hidden"
            ...
            <div className="scrollbar-hide flex-1 overflow-y-auto bg-gradient-to-b from-gray-50 to-white">
              ...
              <div className="py-1">
                {menuItems.map((item, index) => (
                  <div
                    ...
                    className={cn(
                      ...
                      isHovered || isOpen
                        ...
                        : "mx-1 justify-center rounded-lg px-2 py-2.5 hover:bg-blue-50",
                  ...
                  >
                    ...
                    <div className="absolute top-1/2 left-0 h-0 w-1 -translate-y-1/2 rounded-r-full bg-blue-600 opacity-0 transition-all duration-200 group-hover:h-8 group-hover:opacity-100"></div>
                    ...
                    >
                      <div
                        className={cn(
                          "relative flex shrink-0 items-center justify-center rounded-lg p-1.5 transition-all duration-200",
                          !(isHovered || isOpen) &&
                    ...
                    {(isHovered || isOpen) && !item.isLogout && (
                      <ChevronRightIcon className="h-4 w-4 shrink-0 text-gray-400 transition-transform duration-200 group-hover:translate-x-1 group-hover:text-blue-600" />
                    )}
                  </div>
                ))}
              </div>
