...
export default function reducer(state = initialState, action) {
  switch (action.type) {
    ...
    case globalActionTypes.REMOVE_EVENT_ELEMENT_CONFIRMATION:
      return {
        ...state,
        toggleRemoveEventElementConfirmation: !state.toggleRemoveEventElementConfirmation,
      }
    ...
    case globalActionTypes.TOGGLE_UPDATE_EMAIL_PHONE_VERIFY_MODAL:
      return {
        ...state,
        toggleUpdateEmailPhoneVerifyModal: !state.toggleUpdateEmailPhoneVerifyModal,
      }
    ...
    case globalActionTypes.TOGGLE_INVITATION_AFTER_REGISTRATION: {
      return {
        ...state,
        toggleInvitationAfterRegistrationModal: !state.toggleInvitationAfterRegistrationModal,
      }
    }
    ...
    case globalActionTypes.TOGGLE_MASS_UPLOAD_GAME_FROM_TOURNAMENT_MODAL: {
      return {
        ...state,
        toggleMassUploadGameFromTournamentModal: !state.toggleMassUploadGameFromTournamentModal,
      }
    }
    ...
    case globalActionTypes.TOGGLE_FORM_ASSIGNED_MODAL: {
      return {
        ...state,
        toggleAssignedRegistrationFormModal: !state.toggleAssignedRegistrationFormModal,
      }
    }
    ...
    case globalActionTypes.TOGGLE_MORE_USER_LIST_REGISTRATION_FORM_MODAL: {
      return {
        ...state,
        toggleUserListMoreRegistrationFormModal: !state.toggleUserListMoreRegistrationFormModal,
      }
    }
    ...
    case globalActionTypes.TOGGLE_CHECK_TEAMS_FROM_CLUB_SEASON_ASSIGN_MODAL: {
      return {
        ...state,
        toggleCheckTeamFromProgramForSeasonAssignModal: !state.toggleCheckTeamFromProgramForSeasonAssignModal,
      }
    }
    ...
    case globalActionTypes.TOGGLE_FIGURE_PAY_ACCOUNT_UPDATE_MODAL: {
      return {
        ...state,
        toggleFigurePayAccountUpdateModal: !state.toggleFigurePayAccountUpdateModal,
      }
    }
    ...
    case globalActionTypes.TOGGLE_MASS_UPLOAD_USER_FOR_CAMP_CLINIC_MODAL: {
      return {
        ...state,
        toggleMassUploadUserForCampClinicModal: !state.toggleMassUploadUserForCampClinicModal,
      }
    }
