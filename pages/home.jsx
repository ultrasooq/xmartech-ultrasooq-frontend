    ...
    return (
        <SiteLayout>
            ...
            <section className='w-full py-8'>
                <div className='container m-auto px-3'>
                    <div className='flex flex-wrap'>
                        <div className='w-full sm:w-1/2 sm:pr-3.5 mb-4 sm:mb-0'>
                            <div className='w-full sm:h-96 h-auto relative'>
                                ...
                                <div className='w-full h-full absolute top-0 left-0 p-8 bg-gradient-to-r from-slate-100 to-transparent flex items-center justify-start'>
                                    <div className='lg:w-9/12 md:w-10/12 text-light-gray text-sm font-normal'>
                                        <h6 className='text-sm font-normal text-dark-orange uppercase m-0'>SAMSUNG</h6>
                                        <h3 className='lg:text-4xl text-2xl font-medium capitalize text-color-dark mb-2.5'>sed do eiusmod tempor incididunt</h3>
                                        <p>Only 2 days:</p>
                ...
                <div className='container m-auto px-3'>
                    <div className='flex flex-wrap'>
                        ...
                        <div className='w-full'>
                            <div className='bg-neutral-100 lg:p-8 p-4'>
                                <div className='w-full block'>
                                    <ul className='flex flex-wrap items-end justify-between border-b border-solid border-gray-300'>
                                        <li className='text-center mb-2 w-2/6 sm:w-1/5 md:w-auto'>
                                            <a href='#' className='flex flex-col items-center text-light-gray text-xs lg:text-sm font-normal capitalize lg:p-3 p-1 border-b border-solid border-transparent'>
                                                <img src='images/tt-1.svg' className='mb-3 md:max-w-7 lg:max-w-none'/>
                                ...
                                <div className='w-full block py-5'>
                                    <div className='w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 lg:grid-cols-8'>
                                        <div className='w-auto my-3.5 text-center flex items-end justify-center'>
                                            <a href='#' className='text-light-gray lg:text-base text-xs font-normal capitalize max-w-full'>
                                                <div className='mb-3'>
            ...
            <section className='w-full py-8'>
                <div className='container m-auto px-3'>
                    <div className='flex flex-wrap'>
                        <div className='w-full flex flex-wrap items-center justify-between pb-3.5 border-b border-solid border-gray-300'>
                            <div className='flex flex-wrap items-center justify-start'>
                                <h4 className='text-color-dark md:text-2xl text-xl font-normal capitalize md:mr-6 mr-3 whitespace-nowrap'>Deal of the day</h4>
                                <span className='md:text-lg text-sm font-medium capitalize md:px-5 md:py-2.5 px-3 py-1.5 rounded bg-dark-orange text-white'>End in: 26:22:00:19</span>
                            </div>
                            <div className='flex flex-wrap items-center justify-end'>
                                <a href="#" className='text-sm font-normal text-black underline sm:mr-0 mr-3.5'>View all</a>
                            </div>
                        </div>
                        <div className='w-full pt-10 grid lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-3 grid-cols-2'>
                ...
                <div className='container m-auto px-3'>
                    <div className='flex flex-wrap'>
                        <div className='w-full flex flex-wrap items-center justify-between py-3.5 px-3.5 border-b border-solid border-gray-300 bg-neutral-100'>
                            <div className='flex flex-wrap items-center justify-start'>
                                <h4 className='text-color-dark md:text-2xl text-xl font-normal capitalize md:mr-6 mr-3 whitespace-nowrap'>Best Seller In The Last Month</h4>
                            </div>
                            <div className='flex flex-wrap items-center justify-start sm:justify-end'>
                                <a href="#" className='text-sm font-normal text-black sm:mr-0 mr-3.5'>Iphone</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>Ipad</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>Samsung</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>View all</a>
                            </div>
                        </div>
                        <div className='w-full pt-10 grid lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-3 grid-cols-2'>
            ...
            <section className='w-full py-8'>
                <div className='container m-auto'>
                    <div className='flex'>
                        <div className='w-full bg-neutral-100 lg:py-24 lg:px-10 py-12 px-5 relative flex flex-wrap'>
                            <div className='md:w-6/12 sm:w-12/12 w-12/12 pr-3.5 flex flex-wrap items-center content-center'>
                                <h3 className='text-color-dark lg:text-4xl text-2xl font-normal leading-10 capitalize'>Contrary to popular belief, Lorem Ipsum is not..</h3>
                            ...
                            <div className='md:w-3/12 sm:w-4/12 w-12/12 px-3.5 flex flex-wrap items-center content-center'>
                            ...
                            <div className='md:w-3/12 sm:w-8/12 w-12/12 pl-3.5 flex'>
                                <div className='w-auto h-full max-w-full max-h-full md:absolute top-0 right-0 bottom-0 m-auto static'>
            ...
            <section className='w-full py-8'>
                <div className='container m-auto'>
                    <div className='flex flex-wrap'>
                        <div className='w-full flex flex-wrap items-center justify-between py-3.5 px-3.5 border-b border-solid border-gray-300 bg-neutral-100'>
                            <div className='flex flex-wrap items-center justify-start'>
                                <h4 className='text-color-dark md:text-2xl text-xl font-normal capitalize md:mr-6 mr-3 whitespace-nowrap'>Computers & Technology</h4>
                            </div>
                            <div className='flex flex-wrap items-center justify-start sm:justify-end'>
                                <a href="#" className='text-sm font-normal text-black sm:mr-0 mr-3.5'>Laptop</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>Desktop PC</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>Smartphone</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>Mainboars</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>PC Gaming</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>Accessories</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>View all</a>
                            </div>
                        </div>
                        <div className='w-full pt-10 grid lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-3 grid-cols-2'>
            ...
            <section className='w-full py-8'>
                <div className='container m-auto'>
                    <div className='flex flex-wrap'>
                        <div className='w-full flex flex-wrap items-center justify-between py-3.5 px-3.5 border-b border-solid border-gray-300 bg-neutral-100'>
                            <div className='flex flex-wrap items-center justify-start'>
                                <h4 className='text-color-dark md:text-2xl text-xl font-normal capitalize md:mr-6 mr-3 whitespace-nowrap'>Home Electronics</h4>
                            </div>
                            <div className='flex flex-wrap items-center justify-start sm:justify-end'>
                                <a href="#" className='text-sm font-normal text-black sm:mr-0 mr-3.5'>Smart</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>TV LED</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>Air Conditions</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>Sony Speakers</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>Panasonic Refrigerations</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>View all</a>
                            </div>
                        </div>
                        <div className='w-full pt-10 grid lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-3 grid-cols-2'>
            ...
            <section className='w-full py-8'>
                <div className='container m-auto'>
                    <div className='flex flex-wrap'>
                        <div className='w-full flex flex-wrap items-center justify-between py-3.5 px-3.5 border-b border-solid border-gray-300 bg-neutral-100'>
                            <div className='flex flex-wrap items-center justify-start'>
                                <h4 className='text-color-dark md:text-2xl text-xl font-normal capitalize md:mr-6 mr-3 whitespace-nowrap'>Cameras & Videos</h4>
                            </div>
                            <div className='flex flex-wrap items-center justify-start sm:justify-end'>
                                <a href="#" className='text-sm font-normal text-black sm:mr-0 mr-3.5'>Videos</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>Projectors</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>Digital Cameras</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>Printers & Scanners</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>Accessories</a>
                                <a href="#" className='text-sm font-normal text-black sm:ml-3.5 sm:mr-0 mr-3.5'>View all</a>
                            </div>
                        </div>
