                            ...
                            <div className="before_login_form_wrap">
                                <div className="row">
                                    ...
                                    <div className="col-lg-12 form-group custom_radio">
                                        ...
                                        <div className="custom_radio_wrap">
                                            <input type="radio" id="Company" name="trade" value="Female"/>
                                    ...
                                    <div className="col-lg-12 form-group">
                                        ...
                                        <div className="form_field_wrap">
                                            <input type="date" className="form-control" value="19th December 1985 "/>
                                        </div>
                                    </div>
                                    <div className="col-lg-12 form-group">
                                        <label>Email</label>
                                        <div className="form_field_wrap">
                                            <input type="email" className="form-control" value="xeyes95396@beeplush.com "/>
                                        </div>
                                    </div>
                                    <div className="col-lg-12 form-group">
                                        <div className="add_text_wrap">
                                            ...
                                            <div className="add_link_text">
                                                <span><img src="images/add-icon.svg"/> add Phone Number</span>
                                            </div>
                                        </div>
                                        <div className="form_field_wrap">
                                            <input type="text" className="form-control" value="(011) 12458 74589 "/>
                                        </div>
                                    </div>
                                    <div className="col-lg-12 form-group social_wrap">
                                        <div className="add_text_wrap">
                                            ...
                                            <div className="add_link_text">
                                                <span><img src="images/add-icon.svg"/> add link</span>
                                            </div>
                                        </div>
                                        <div className="form_field_wrap social_wrap_box">
                                            <div className="social_wrap_top">
                                                <div className="social_wrap_top_left">
                                                    <span><img src="images/social-facebook-icon.svg"/> Facebook</span>
                                                </div>
                                                <div className="social_wrap_top_right">
                                                    <ul>
                                                        <li><img src="images/social-edit-icon.svg"/></li>
                                                        <li><img src="images/social-delete-icon.svg"/></li>
                                                        <li><img src="images/social-arrow-icon.svg"/></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <label>Link</label>
                                            <input type="text" className="form-control" value="www.facebook_Lorem ipsum & 4115.com "/>
                                        </div>
                                        <div className="form_field_wrap social_wrap_box">
                                            <div className="social_wrap_top">
                                                <div className="social_wrap_top_left">
                                                    <span><img src="images/social-linkedin-icon.svg"/> Linkedin</span>
                                                </div>
                                                <div className="social_wrap_top_right">
                                                    <ul>
                                                        <li><img src="images/social-edit-icon.svg"/></li>
                                        ...
                                        <div className="form_field_wrap social_wrap_box">
                                            <div className="social_wrap_top">
                                                <div className="social_wrap_top_left">
                                                    <span><img src="images/social-instagram-icon.svg"/> Instagram</span>
                                                </div>
                                                <div className="social_wrap_top_right">
                                                    <ul>
                                                        <li><img src="images/social-edit-icon.svg"/></li>
                                        ...
                                        <div className="form_field_wrap social_wrap_box">
                                            <div className="social_wrap_top">
                                                <div className="social_wrap_top_left">
                                                    <span><img src="images/social-twitter-icon.svg"/> Twitter</span>
                                                </div>
                                                <div className="social_wrap_top_right">
                                                    <ul>
                                                        <li><img src="images/social-edit-icon.svg"/></li>
