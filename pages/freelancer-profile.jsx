                    ...
                    <div className='flex'>
                        <div className='md:w-10/12 lg:w-10/12 w-11/12 shadow-sm border border-solid border-gray-300 rounded-lg bg-white m-auto mb-12 lg:p-12 sm:p-8 p-6'>
                            <div className='w-full text-sm text-normal leading-6 text-light-gray text-center m-auto mb-7'>
                                <h2 className='sm:text-4xl font-semibold sm:leading-10 text-center text-color-dark mb-3 text-3xl leading-8'>Freelancer Profile</h2>
                            </div>
                            <div className='w-full flex flex-wrap'>
                                <div className='w-full mb-4'>
                                    <div className='w-full mt-2.5 border-b-2 border-dashed border-gray-300'>
                                        <label className='text-lg font-medium leading-5 text-left text-color-dark mb-3.5 block capitalize'>Freelancer Information</label>
                                    </div>
                                </div>
                                ...
                                <div className='w-full mb-3.5'>
                                    <div className='flex flex-wrap'>
                                        <div className='w-full mb-4'>
                                            <div className='w-full mt-2.5 border-b-2 border-dashed border-gray-300'>
                                                <label className='text-lg font-medium leading-5 text-left text-color-dark mb-3.5 block capitalize'>Address</label>
                                            </div>
                                        </div>
                                        ...
                                        <div className='md:w-6/12 w-full mb-4 md:pr-3.5'>
                                            <label className='text-sm font-medium leading-4 text-left text-color-dark mb-3.5 block capitalize'>contact number</label>
                                            <div className='w-full h-14 rounded border border-solid border-gray-300 relative'>
                                                <input type='text' placeholder='Branch Contact Number' className='w-full h-full rounded py-2.5 px-4 text-sm font-normal leading-4 text-left border-0 text-light-gray placeholder:text-sm placeholder:font-normal placeholder:leading-4 placeholder:text-light-gray focus:outline-none'/>
                                            </div>
                                        </div>
                                        <div className='md:w-6/12 w-full mb-4 md:pl-3.5'>
                                            <label className='text-sm font-medium leading-4 text-left text-color-dark mb-3.5 block capitalize'>contact name</label>
                                            <div className='w-full h-14 rounded border border-solid border-gray-300 relative'>
                                                <input type='text' placeholder='Branch Contact Name' className='w-full h-full rounded py-2.5 px-4 text-sm font-normal leading-4 text-left border-0 text-light-gray placeholder:text-sm placeholder:font-normal placeholder:leading-4 placeholder:text-light-gray focus:outline-none'/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className='w-full flex flex-wrap'>
                                <div className='w-full mb-4'>
                                    <div className='w-full mt-2.5 border-b-2 border-dashed border-gray-300'>
                                        <label className='text-lg font-medium leading-5 text-left text-color-dark mb-3.5 block capitalize'>Working Hours</label>
                                    </div>
                                </div>
