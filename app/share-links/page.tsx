/**
 * @file Share Links Page - app/share-links/page.tsx
 * @route /share-links
 * @description Lists all shared product links generated by the current user for seller
 *   reward programs. Displays a paginated table with link ID, product info, URL, click
 *   count, and a "Copy" action to copy the share link to the clipboard. Requires
 *   PERMISSION_SHARE_LINKS; redirects to /home if denied.
 * @authentication Required; permission-gated via checkPermission(PERMISSION_SHARE_LINKS).
 * @key_components Pagination
 * @data_fetching
 *   - useShareLinks({ page, limit, sortType }) for paginated share link list
 * @state_management Local state for page; clipboard copy via document.execCommand('copy').
 */
