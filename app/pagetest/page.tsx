    ...
    <>
      <section className="relative w-full py-7">
        <div className="container m-auto px-3">
          <div className="text-light-gray relative w-full px-5 pb-4 pt-8 text-sm font-normal capitalize sm:px-10 sm:pb-10 sm:pt-16">
              ...
              <div className="w-full sm:w-5/12 md:w-5/12 lg:w-4/12">
                <div className="w-auto">
                  <ul className="flex items-center">
                    <li className="text-light-gray mr-2.5 flex text-sm leading-7">
                ...
                <h3 className="text-color-dark w-auto text-xl font-normal capitalize md:text-2xl lg:text-4xl">
                  Sed Do Eiusmod Tempor Incididunt
                </h3>
                <p className="text-light-gray text-sm capitalize leading-7">
                  Only 2 Days:
                </p>
                <h4 className="nd:text-xl text-olive-green text-lg font-medium">
                  21/10 & 22/10
                </h4>
                <a
                  href="#"
                  className="bg-dark-orange mt-3 inline-block rounded-sm px-6 py-3 text-sm font-bold text-white"
                >
                  {" "}
                  Shop Now{" "}
                </a>
              ...
              <div className="flex w-full">
                ...
                >
                  ...
                  <div className="text-normal h-auto w-full pl-2.5 text-center text-xs sm:w-[calc(100%_-_6rem)] sm:text-left">
                    <h6 className="text-color-dark mb-2 text-sm font-normal">
                      Clothing & Apparel
                    </h6>
          ...
          <div className="flex flex-wrap">
            <div className="w-full px-3.5 lg:w-3/12">
              <div className="mb-7 w-full border border-solid border-gray-300">
                ...
                <div className="flex w-full flex-wrap p-3.5">
                  <div className="flex w-auto items-center justify-between p-0 px-2 lg:w-full lg:px-0">
                    <label className="text-light-gray flex w-full items-center justify-start text-sm font-normal leading-8">
                      <input
                        type="checkbox"
                        name=""
              ...
              <div className="mb-7 w-full border border-solid border-gray-300">
                ...
                <div className="flex w-full items-center justify-between px-3.5 py-2.5">
                  <select className="text-light-gray h-auto w-20 border border-solid border-gray-300 px-1.5 py-2 text-sm font-normal leading-8 focus:outline-none">
                    <option>$0</option>
                    <option>$100</option>
                    <option>$200</option>
                    <option>$400</option>
              ...
              <div className="flex flex-wrap">
                <div className="flex w-full flex-wrap items-center justify-between border-b border-solid border-gray-300 bg-neutral-100 px-3.5 py-3.5">
                  ...
                  <div className="flex flex-wrap items-center justify-start sm:justify-end">
                    <div className="w-auto">
                      <select className="text-light-gray border border-solid border-gray-300 bg-white px-3.5 py-2.5 text-sm font-normal">
                    ...
                    <div className="ml-5 w-auto">
                      <ul className="flex items-center justify-end gap-x-5">
                        <li className="text-light-gray text-sm font-normal leading-6">
                          View
                        </li>
                        <li className="text-light-gray text-sm font-normal leading-6">
                          <a href="#">
                ...
                <div className="mb-12 mt-6 flex w-full items-center justify-center">
                  <a
                    href="#"
                    className="border-dark-orange bg-dark-orange mx-0.5 flex h-9 w-auto items-center justify-center rounded-sm border border-solid px-1.5 py-1 text-sm leading-4 text-white sm:mx-1 sm:px-3.5 sm:py-1"
                  >
                    <img
                  ...
                  <a
                    href="#"
                    className="text-color-dark mx-0.5 flex h-9 w-9 items-center justify-center border border-solid border-gray-300 bg-white px-1.5 py-1 text-sm leading-4 sm:mx-1 sm:px-3.5 sm:py-1"
                  >
