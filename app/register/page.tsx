      ...
      <Dialog open={isTermsModalOpen} onOpenChange={handleToggleTermsModal}>
        <DialogContent className="md:!max-w-4xl">
          ...
          <DialogDescription className="max-h-[500px] min-h-[300px] overflow-y-auto text-sm font-normal leading-7 text-color-dark">
            ...
            <p className="mb-3">These terms and conditions outline the rules and regulations for the use of Puremoon Website, located at www.Puremoon.com.</p>

            <p className="mb-3">By accessing this website we assume you accept these terms and conditions. Do not continue to use [Website/Service] if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <h4 className="text-lg capitalize font-bold text-color-dark mt-4">Cookies</h4>

            <p className="mb-3"> We employ the use of cookies. By accessing [Website/Service], you agreed to use cookies in agreement with the [Website/Service]'s Privacy Policy.</p>

            <p className="mb-3">Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.</p>

            <h4 className="text-lg capitalize font-bold text-color-dark mt-4">License</h4>

            <p className="mb-3">Unless otherwise stated, [Website/Service] and/or its licensors own the intellectual property rights for all material on [Website/Service]. All intellectual property rights are reserved. You may access this from [Website/Service] for your own personal use subjected to restrictions set in these terms and conditions.</p>
