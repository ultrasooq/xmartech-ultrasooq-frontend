            ...
            <li className="w-full py-4">
              ...
              >
                <div className="flex h-[33px] w-[33px] items-center justify-center ">
                  <img src="/images/task-icon.svg" alt="Task Icon" />
                </div>
        ...
        <div className="flex w-full rounded-sm border border-solid border-gray-300">
          <div className="w-[22%] border-r border-solid border-gray-300">
            ...
            <div className="flex w-full flex-wrap bg-white px-[20px] py-[25px] shadow-lg">
              <div className="border-color-[#DBDBDB] h-auto w-20 border border-solid p-3">
          ...
          <div className="w-[20%] border-r border-solid border-gray-300">
            ...
            <div className="w-full p-4">
              <div className="mb-5 flex w-full flex-wrap rounded-md px-[10px] py-[20px] shadow-lg">
                    ...
                    <div className="flex w-full">
                      <div className="w-[25%] text-xs font-normal text-gray-500">
                        <div className="flex w-full flex-wrap">
                          ...
                          <div className="font-nromal flex w-[calc(100%-3rem)] items-center justify-start pl-3 text-sm text-xs text-black">
                            Lorem Ipsum is simply dummy text..
                          </div>
                        </div>
                      </div>
