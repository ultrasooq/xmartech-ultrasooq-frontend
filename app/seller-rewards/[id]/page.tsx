/**
 * @file Seller Reward Detail Page - app/seller-rewards/[id]/page.tsx
 * @route /seller-rewards/:id (dynamic segment = seller reward ID)
 * @description Displays all shared links associated with a specific seller reward program.
 *   Shows a paginated table of shared links with columns: link ID, user name (generated by),
 *   product URL, clicks, created date. Requires PERMISSION_SELLER_REWARDS; redirects to /home
 *   if permission is denied.
 * @authentication Required; permission-gated via checkPermission(PERMISSION_SELLER_REWARDS).
 * @key_components Pagination, Link (Next.js)
 * @data_fetching
 *   - useShareLinksBySellerReward({ page, limit, sellerRewardId }) for paginated shared links
 * @state_management Local state for page number; useParams for dynamic route segment.
 */
