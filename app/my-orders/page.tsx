...
const MyOrdersPage = () => {
  return <div className="my-order-main">
      ...
      <div className="my-order-wrapper">
        ...
        <div className="right-div">
          <div className="order-search-bar">
            <input type="text" className="custom-form-control-s1" placeholder="Search..."></input>
            <button type="button" className="search-btn theme-primary-btn"><FiSearch />Search Orders</button>
          </div>
              ...
              <div className="my-order-card">
                <div className="my-order-box">
                  ...
                  <div className="right-info">
                    <h4><BiSolidCircle color="green" /> Delivered on Mar 29</h4>
                    <p>Your Item has been delivered</p>
                    <a href="#" className="ratingLink"><PiStarFill />Rate & Review Product</a>
                  </div>
                </div>
                <div className="my-order-box">
                  <figure>
