                  ...
                  <div className="my-order-card">
                    <div className='delivery-address'>
                      <div className='delivery-address-col deliveryAddress'>
                        ...
                        <address>Nodakhali budge budge block 2, Howri Bhowmick Para, <br /> pin - 743318</address>
                      ...
                      <div className='delivery-address-col moreActions'>
                        ...
                        <figure className='downloadInvoice'>
                          <figcaption>
                            <a href='javascript' className='downloadInvoice-btn theme-primary-btn'><LiaFileInvoiceSolid /> Download Invoice</a></figcaption>
                        </figure>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="my-order-box">
                        ...
                        <div className='order-delivery-progess-s1'>
                          <ul>
                            <li className='complted'>
                              <div className='orderStatusText'>Order Received</div>
                              <div className='dot'><small></small></div>
                              <div className='orderDateText'>Fri, 29th Mar</div>
                            </li>
                            <li className='complted'>
                              <div className='orderStatusText'>Order Confirmed</div>
                              <div className='dot'><small></small></div>
                              <div className='orderDateText'>Fri, 29th Mar</div>
                            </li>
                            <li className='complted'>
                            ...
                            <li className='current'>
                              <div className='orderStatusText'>Out for delivery</div>
                              <div className='dot'><small></small></div>
                              <div className='orderDateText'>Fri, 29th Mar</div>
                            </li>
                            <li>
                      ...
                      <div className="right-info">
                        ...
                        <div className='more-actions'>
                          <button type='button' className='theme-primary-btn update-status-btn'>Update Status</button>
                        </div>
                      </div>
                    </div>
                    <div className="my-order-box">
                      ...
                      <div className="center-div">
                        <h4>Coupon Code - <strong>FLTBPIPGL7UBTF</strong>, claim before Jun 30,2024</h4>
                        <a href="#" className="ratingLink">How To claim?</a>
                      </div>
                      <div className="right-info">
                        <a href="#" className="ratingLink">
                          <PiStarFill />
