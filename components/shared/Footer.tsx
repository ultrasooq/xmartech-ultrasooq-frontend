    ...
    <footer className="mt-16 w-full bg-gray-900 text-gray-300">
      ...
      <div className="container mx-auto px-4 py-12 sm:px-6 md:py-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-12 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <h3
              className="mb-4 text-base font-semibold tracking-wider text-white uppercase"
              translate="no"
            >
              {t("quick_links")}
            </h3>
      ...
      <Dialog open={isTermsModalOpen} onOpenChange={handleToggleTermsModal}>
        <DialogContent className="md:max-w-4xl!">
          ...
          <DialogDescription className="text-color-dark max-h-[500px] min-h-[300px] overflow-y-auto pr-2 text-sm leading-7 font-normal">
            <TermsContent />
          </DialogDescription>
        </DialogContent>
      </Dialog>
