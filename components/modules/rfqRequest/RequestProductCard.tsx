...
const RequestProductCard = () => {
  return (
    <div className="flex w-full flex-wrap bg-white px-[10px] py-[15px] shadow-lg">
      <div className="border-color-[#DBDBDB] h-auto w-16 border border-solid p-1">
        <Image src={PlaceholderImage} alt="placeholder" />
      </div>
      <div className="font-nromal flex w-[calc(100%-4rem)] items-center justify-start pl-3 text-sm text-[#1D77D1]">
