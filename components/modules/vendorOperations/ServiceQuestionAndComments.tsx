...
import { useServiceQuestions } from "@/apis/queries/question.queries";
import { Dialog, DialogContent } from "@/components/ui/dialog";
import { Button } from "@/components/ui/button";
import AnswerForm from "../serviceDetails/AnswerForm";
...
const ServiceQuestionAndAnswers: React.FC<QuestionAndAnswersProps> = ({
  ...
  const questionQuery = useServiceQuestions(
    {
      page: page,
      limit: limit,
...
export default ServiceQuestionAndAnswers;