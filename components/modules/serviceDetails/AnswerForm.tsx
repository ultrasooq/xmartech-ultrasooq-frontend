...
import { useUpdateAnswer, useUpdateServiceAnswer } from "@/apis/queries/question.queries";
...
const AnswerForm: React.FC<AnswerFormProps> = ({ onClose, serviceId, questionId, onReplySuccess }) => {
  ...
  const updateAnswer = useUpdateServiceAnswer();
